...
const Orglist = () => {
  ...
  return (
    ...
    <Layout>
        {/* Organisation list  */}
        <div className="p-4">
              <h2 className="text-2xl font-semibold mb-4 text-center">Organisation List</h2>
                  ...
                  <tbody>
                    {Data?.map((org, index) => (
                      <tr key={index} className="border-b hover:bg-gray-50">
                        <td className="p-3">{org.organisationName}</td>
              ...
              <div className="lg:hidden space-y-4">
                {Data?.map((org, index) => (
                  <div key={index} className="bg-white p-4 rounded-lg shadow-md">
                    <div className="font-semibold text-lg">{org.organisationName}</div>
